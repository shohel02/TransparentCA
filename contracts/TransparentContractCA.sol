...
// A contract among CA, Domain owner and application provider.
...
contract PolicyContract{
    ...
    function publishCAtoDomainPolicyContract(uint id, string applicationPolicyAddress, uint applicationPolicyId,
          ...
          //call it later on
          applicationPolicyPublisher.subscribeApplicationPolicy(id, applicationPolicyId,
...
contract ApplicationPolicyPublisher {
    ...
    //publish trust policy of an application for a CA
